<template>
  <div class="content-wrapper">
    <v-card width="80%">
      ...
      <v-card-text>
        <v-form ref="form" lazy-validation style="width: 80%">
          <v-autocomplete v-model="city" :items="cityNames" outlined :label="$t('addMarker.findCityLabel')" />
          <v-text-field
            v-model="description"
            :counter="256"
            outlined
      ...
      <v-card-actions>
        <v-spacer />
        <v-btn :disabled="city === ''" elevation="0" color="primary" @click="onClickAdd">
